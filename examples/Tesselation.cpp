...
int main()
{
    ...
    tri.InsertVertex( vec3(-1.0f, -1.0f, 0.f), vec4(1.f, 0.f, 0.0f, 1.0f) );
    tri.InsertVertex( vec3( 1.0f ,-1.0f, 0.f), vec4(0.f, 1.f, 0.0f, 1.0f) );
    tri.InsertVertex( vec3( 0.0f , 1.0f, 0.f), vec4(0.f, 0.f, 0.1f, 1.0f) );

//    tri.InsertElement( {0,1,2} );
